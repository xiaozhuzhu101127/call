...
public class AppCommand extends BaseCommand {
	...
	public RemoteResponse addCargoOnline(Credential credential,
	    ...
	    addCargoOnline(credential, CT_REGOIN, msg, place);
	...
	public RemoteResponse updateCargoCount(Credential credential,
		...
		Long count = getCargoOnlineService().updateCargoCount(Long.valueOf(CARGOID));
	...
	public RemoteResponse getCargoOnline(Credential credential,
		...
		int count = getCargoOnlineService().countByCria(credential, ca);
		if (count <= offset) {
		...
		onlines = getCargoOnlineService().listByCria(credential, ca);
